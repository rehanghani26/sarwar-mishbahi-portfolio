...
import { fetchSettings, setLocalLanguage, clearLanguageChangeRequest } from '../store/slices/settingsSlice';
...
export default function MainLayout() {
  ...
  const { settings, loading, error, isSettingsLoaded, pendingLanguageChange } = useSelector((state) => state.settings);
  ...
  const handleConfirm = () => {
    ...
    setTimeout(() => {
      ...
      dispatch(setLocalLanguage(pendingLanguageChange));
      dispatch(clearLanguageChangeRequest());
