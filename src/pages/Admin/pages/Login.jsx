...
import { Lock, Eye, EyeOff, Mail, AlertTriangle, ArrowRight, ShieldCheck } from 'lucide-react';
...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!emailRx.test(identifier.trim()) && !phoneRx.test(identifier.trim())) {
      setLocalError('Please enter a valid email or 10-digit phone number starting with 6-9.');
      return;
    }
