...
export default function About() {
  ...
  return (
    <div className={`bg-site-bg py-12 transition-colors duration-200 min-h-screen ${language === 'ur' ? 'text-right' : 'text-left'}`} dir={language === 'ur' ? 'rtl' : 'ltr'}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="premium-card p-8 mb-8 relative overflow-hidden text-start">
          ...
          <div className="mt-8 border-t border-site-border pt-6">
            <h2 className="text-lg font-bold text-text-primary mb-3 font-serif">
