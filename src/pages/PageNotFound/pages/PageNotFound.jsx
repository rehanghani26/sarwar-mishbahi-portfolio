...
export default function PageNotFound() {
  return (
    <div className="bg-[#FAF9F5] dark:bg-slate-900 min-h-[70vh] flex flex-col items-center justify-center p-6 text-center transition-colors duration-200">
      ...
      <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 font-serif mb-4">صفحہ نہیں ملا</h2>
      ...
      >
        <ArrowRight className="w-4 h-4 text-[#8A6F52] dark:text-[#EAD075]" />
        صفحہ اول پر واپس جائیں
      </Link>
    </div>
  );
}
